...
{  	HttpSession ses=req.getSession();
   ...
   user.setIdproof(file2.getOriginalFilename());
	try {
	file1.transferTo(new File("C:\\Users\\intel\\Documents\\workspace-sts-3.9.10.RELEASE\\BloodDonationSystem\\src\\main\\resources\\static\\images\\"+file1.getOriginalFilename()));
	file2.transferTo(new File("C:\\Users\\intel\\Documents\\workspace-sts-3.9.10.RELEASE\\BloodDonationSystem\\src\\main\\resources\\static\\images\\"+file2.getOriginalFilename()));
	file3.transferTo(new File("C:\\Users\\intel\\Documents\\workspace-sts-3.9.10.RELEASE\\BloodDonationSystem\\src\\main\\resources\\static\\images\\"+file3.getOriginalFilename()));
	}catch(Exception e) {}
